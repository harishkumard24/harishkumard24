...
|---|---|
| 👤 **Name** | Harish Kumar D |
| 🎓 **Education** | M.E. CS @ MSIS Manipal (Distinction) · B.E. @ DSATM Bengaluru |
| 💼 **Experience** | 2+ years — Flipkart · Simplilearn · Tequed Labs · [24]7.ai |
| 🧠 **Domain** | Backend Engineering · AI/ML · Generative AI · RAG Systems |
| 🔬 **Research** | Vision Transformers · Domain Adversarial Learning · RAG Chunking · Demand Forecasting |
| 🔭 **Currently** | Building agentic AI systems + pursuing M.E. research |
| 🤝 **Open To** | AI/ML Internships · SWE Roles · Research Collaborations |
| 📍 **Location** | Bengaluru, India |
| ✉️ **Email** | harishkumard12@gmail.com |

</div>

<br/>

> 💡 **Fun fact:** *"I found that chunking strategy — not model size — was killing RAG quality."*
...
| ✅ Automated validation logic | Cut pricing inconsistencies by **30%** across 300K+ records |
| 🔍 Automated log analysis | Reduced production issue resolution time by **40%** |
| 🧩 Modular backend components | Eliminated manual pricing workflow steps entirely |
